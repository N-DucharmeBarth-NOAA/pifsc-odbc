...
Before downloading large tables, use the peek functions to explore structure and content:
...
- Inspecting data types and column names
- Validating data in large tables without pulling all rows
